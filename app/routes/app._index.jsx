...
// discount that has been synced by the app) as a table — title, type (code
// vs automatic), how many products it applies to, description, and its
// date range. Clicking a row opens the detail page for that offer.
// ---------------------------------------------------------------------------
